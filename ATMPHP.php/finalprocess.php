...
<div class="container-fluid welcome" style="background-image:url('https://wallpaperaccess.com/full/2910881.jpg')">
    ...
    <div class="container head1" id="final">
        <p class="display-4 head">Dear Customer,Please Wait Your Transaction Is Processing
        </p>   
    </div> 
    <?php>
  ...
  $userId = $_SESSION["mainID"];

  $qry = mysqli_query($conn, "SELECT balance FROM myguests WHERE a_id = '$userId'") or die(mysqli_error($conn));
...
?>
    ...
    <div class="popup" id="popup">
        ...
        <button type="button" id="exit" class="btn btn-danger btn-lg mb-3">LOG OUT</button>
        <p>AVAILABLE BALANCE:<?php if ($s) {echo ' ' .$s;} ?></p>
    </div>
    </div>
